...
import { GuidedMixingMode } from './GuidedMixingMode';
...
export const AuthorizedRecipeCalculatorApp: React.FC = () => {
  ...
  // Subscribe to store updates while authorized
  useEffect(() => {
    // Initial sync
    ...
    // Run quick unit test diagnostic for dashboard status
